...
struct MyArgs : public argparse::Args{
    ...
    std::string& login = kwarg("l", "Login").set_default(std::string("rabbitmq"));
    std::string& pass = kwarg("p", "Password").set_default(std::string("rabbitmq"));
    std::string& read_queue_name = kwarg("o", "Output (read) queue name").set_default(std::string("read_queue"));
    std::string& write_queue_name = kwarg("i", "Input (write) queue name").set_default(std::string("write_queue"));
